export default function Media() {
  ...
  return (
    <div className={bodyClassName}>
      <section>
        <h1 className={titleGreyDLClassName}>MEDIA MATTERS</h1>
        <h2 className={subTitleGreyClassName}>HONOURABLE STAMP MENTIONS</h2>
      ...
      <section>
        <h1 className={titleGreyDLClassName}>INTERVIEWS</h1>
        <div className="grid grid-cols-1 mobileLg:grid-cols-2 gap-6 desktop:gap-12">
          <div className="flex flex-col">
            <h2 className={subTitleGreyClassName}>RICE TVX</h2>
          ...
          <div className="flex flex-col">
            <h2 className={subTitleGreyClassName}>WAGE CUCKING</h2>
            <div className="relative w-full pt-[56.25%]">
              {/* 16:9 aspect ratio wrapper */}
              <iframe
                className="absolute top-0 left-0 w-full h-full pb-3 mobileMd:pb-6"
      ...
      <section>
        <h1 className={titleGreyDLClassName}>IN THE NEWS</h1>
        <h2 className={subTitleGreyClassName}>BREAKING</h2>
        <a
      ...
      <section>
        <h1 className={titleGreyDLClassName}>ARTICLES</h1>
        <h2 className={subTitleGreyClassName}>STAMP STORIES</h2>
        <a
      ...
      <section>
        <h1 className={titleGreyDLClassName}>REPORTS</h1>
        <div className="grid grid-cols-1 mobileLg:grid-cols-3 gap-3 mobileMd:gap-6 desktop:gap-12">
          <div className="col-span-1 mobileLg:col-span-2">
            <h2 className={subTitleGreyClassName}>SQRR - DEEP DIVE</h2>
            <p className={bodyTextLightClassName}>
            ...
            <div className="flex justify-end mobileLg:justify-start">
              <a
                ...
                target="_blank"
              >
                <button className={buttonGreyOutlineClassName}>DOWNLOAD</button>
              </a>
            </div>
          </div>
          <div className="col-span-1 mobileLg:text-right">
            <h2 className={subTitleGreyClassName}>INSIGHTS</h2>
            <p className={bodyTextLightClassName}>
            ...
            <div className="flex justify-end">
              <a href="https://sqrr.xyz/reports/" target="_blank">
                <button className={buttonGreyOutlineClassName}>READ</button>
              </a>
            </div>
          </div>
        </div>
