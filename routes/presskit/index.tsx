  ...
  return (
    ...
    >
      ...
      <section className={"flex flex-col md:flex-row gap-6 md:gap-12"}>
        ...
        <div
          className={"text-[#FFA100] flex flex-col items-center md:items-end gap-6 md:gap-12 w-full md:w-1/2"}
        >
      ...
      <section className={"flex flex-col md:flex-row gap-6 md:gap-12"}>
        ...
        <div
          className={"flex flex-col items-center md:items-end gap-6 md:gap-12 w-full md:w-1/2"}
        >
          <p
