    ...
    <div className="text-[#CCCCCC] text-lg font-medium flex flex-col gap-12 mt-20 md:mt-40">
      <div className="max-w-[660px] w-full mx-auto flex flex-col gap-12">
        <section>
          ...
          <PlaceholderImage width={660} height={318} />
          <p className="mt-6">
        ...
        <section className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6">
            <div className="space-y-6">
              ...
              <PlaceholderImage width={318} height={178} />
            </div>

            <div className="space-y-6">
              <PlaceholderImage width={318} height={424} />
              <p>
        ...
        <section className="flex flex-col gap-3">
          ...
          <PlaceholderImage width={660} height={372} />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-3">
            ...
            <PlaceholderImage width={318} height={318} />
          </div>
        </section>
      </div>
