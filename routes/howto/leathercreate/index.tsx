      ...
      <div className="max-w-[660px] w-full mx-auto flex flex-col gap-12">
        <section>
          ...
          <p className="mb-12">
            ...
            <br />
            Download the Leather.io extension for chrome from the Chrome web
            store.<br />
            <br />
            ...
            <br />
            Once that extension is downloaded and installed you will see this
            screen.
            <br />
            ...
            <br />
            Critical Reminder! Make sure to back up your secret key in a secure
            location. <br />
            If you lose your secret key, you won't be able to restore or import
            it. <br />
            Additionally, if someone gains access to your secret key, they will
            have full control of your wallet.<br />
