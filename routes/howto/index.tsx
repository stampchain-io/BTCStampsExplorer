    ...
    return (
        <div className="text-[#CCCCCC] text-xl font-medium flex flex-col gap-12 mt-20 md:mt-40">
            <section className="mb-6">
                ...
                <p className="mb-12">
                    Explore our comprehensive How-To section, where you’ll find step-by-step guides for the most popular features on our platform. <br />
                    Whether you're a beginner or a pro, these guides will help you make the most out of every tool we offer. <br />
            ...
            <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div className="md:col-span-2 flex flex-col gap-3">
                        <p>
                            SRC-20 is a fungible token protocol that embeds transactions directly onto the Bitcoin blockchain, removing the need for Counterparty as of block 796,000.<br />
                            Inspired by BRC-20, it operates with only standard BTC miner fees while preserving data immutability.<br />
