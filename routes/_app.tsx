          ...
          <ToastProvider>
            <NavigatorProvider>
              <div class="flex flex-col min-h-screen">
                <Header />
                <main
                  class="flex flex-col flex-grow px-6 mobileMd:px-9 tablet:px-12 pt-0 mobileLg:pt-3 tablet:pt-3 pb-12 mobileLg:pb-24 desktop:pb-36 max-w-desktop mx-auto w-full"
                  f-client-nav
                >
                  <Partial name="body">
                    <Component />
