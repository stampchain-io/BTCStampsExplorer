  ...
  return (
    <div className={styles.body}>
      <section className="text-center max-w-full mt-12 mobileLg:mt-[60px] tablet:mt-[72px] mb-[18px] mobileLg:mb-[30px] tablet:mb-[42px] desktop:-mb-1.5 mx-auto">
        <h1 className={styles.titleGreyLD}>
          YOU'VE GOT QUESTIONS
          <br />
          <span className={styles.titleGreyDL}>
            WE'VE GOT ANSWERS
          </span>
        </h1>
      ...
      <section className="flex flex-col gap-6 tablet:gap-12">
        <div>
          <h1 className={styles.titleGreyDL}>BITCOIN STAMPS</h1>
          <h2 className={styles.subTitleGrey}>PERMANENCE FOR PERPETUITY</h2>
          <p className={styles.bodyTextLight}>
      ...
      <section class="flex flex-col gap-6 tablet:gap-12">
        <div>
          <h1 className={styles.titleGreyDL}>GET STARTED</h1>
          <h2 className={styles.subTitleGrey}>
        ...
        <div class={styles.accordion}>
          <Accordion title="COMPATIBLE WALLETS">
            <p className={styles.bodyTextLight}>
              ...
              <ul
                className={`${styles.bodyTextLight} list-disc list-inside mt-2 space-y-1.5`}
              >
                <li>
                  <a
              ...
              <a
                ...
                className={`${styles.bodyTextLight} animated-underline`}
              >
      ...
      <section class="flex flex-col gap-6 tablet:gap-12">
        <div>
          <h1 className={styles.titleGreyDL}>BUYING AND SELLING</h1>
          <h2 className={styles.subTitleGrey}>
      ...
      <section class="flex flex-col gap-6 tablet:gap-12">
        <div>
          <h1 className={styles.titleGreyDL}>SRC-20 TOOLS</h1>
          <h2 className={styles.subTitleGrey}>
      ...
      <section class="flex flex-col gap-6 tablet:gap-12">
        <div>
          <h1 className={styles.titleGreyDL}>GENERAL FAQ</h1>
          <h2 className={styles.subTitleGrey}>COMMON QUESTIONS ANSWERED</h2>
          <p className={styles.bodyTextLight}>
