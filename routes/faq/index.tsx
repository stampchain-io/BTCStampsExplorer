...
export default function FAQ() {
  ...
  log.debug("Rendering FAQ component");

  return (
    <>
      <Head>
        <title>FAQ - Bitcoin Stamps Explorer</title>
        ...
        <section className="flex flex-col gap-6 md:gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
            ...
            <Accordion title="SRC-721">
              <p className="text-sm md:text-lg font-medium">
                SRC-721 is a fungible token system focused on low-cost minting
                of NFTs on Bitcoin. It supports layered storage, reducing
                minting costs by referencing on-chain data through JSON files
                and ensuring long-term immutability. The first SRC-721 token
                (KEVIN) was deployed in Block 788041, modeled after BRC-20 but
                optimized for efficiency and data integrity via the STAMPS
                protocol.
              </p>
            </Accordion>
            ...
            <Accordion title="SRC-721r">
              <p className="text-sm md:text-lg font-medium">
                ...
                recursive NFT creation by leveraging multiple layers of images.
                This allows developers to build complex images with data stored
                across several transactions on Stamps. Its structure maximizes
                cost efficiency, making it suitable for larger, more detailed
                art collections.
              </p>
            </Accordion>
            ...
            <Accordion title="OLGA">
              <p className="text-sm md:text-lg font-medium">
                ...
                transaction size by up to 50% and the cost of minting by 60-70%,
                ...
                accessibility and reducing fees.
              </p>
            </Accordion>
            ...
            <Accordion title="POSH STAMPS">
              <p className="text-sm md:text-lg font-medium">
                ...
                with the Counterparty asset-naming system. They allow for
                wrapping and vaulting other Bitcoin-based assets, such as Runes,
                Ordinals, and SRC-20, to prevent accidental loss and improve
                tradability. This enables easier trading on decentralized
                exchanges and future cross-protocol integration use cases.
              </p>
            </Accordion>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
            ...
            <Accordion title="CREATING COLLECTIONS">
              <p className="text-sm md:text-lg font-medium">
                ...
                ensuring they're inscribed with consistent metadata and styles.
        ...
        <section className="flex flex-col gap-6 md:gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
            <Accordion title="DEPLOYING SRC-20 TOKENS">
              <p className="text-sm md:text-lg font-medium">
                To deploy an SRC-20 token, inscribe the transaction on Bitcoin
                with the token's supply and metadata. This makes the token
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
            ...
            <Accordion title="TRADING AND SELLING STAMPS">
              <p className="text-sm md:text-lg font-medium">
                ...
                platform integration. Some marketplaces are exploring ways to
...
log.info("FAQ component defined");
