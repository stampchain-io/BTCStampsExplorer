    ...
    <div className="text-[#CCCCCC] flex flex-col gap-16 md:gap-36 py-24 md:py-48">
      ...
      <section className="flex flex-col gap-6">
        ...
        <p className="font-courier-prime">
          ...
          by email at stampchain.io@gmail.com or by mail to __________,
          __________, United States. These Legal Terms constitute a legally
          binding agreement made between you, whether personally or on behalf of
          an entity ("you"), and Stampchain, concerning your access to and use
      ...
      <div className="flex flex-col gap-5 text-xs md:text-lg font-courier-prime">
        ...
        <section>
          ...
          stampchain.io@gmail.com. If we ever grant you the permission to post,
          ...
          submissions Please review this section and the "PROHIBITED ACTIVITIES"
          ...
          without acknowledgment or compensation to you. You are responsible for
          what you post or upload: By sending us Submissions through any part of
          ...
          Submission; warrant that any such Submission are original to you or
        ...
        <section>
          ...
          may change prices at any time. All payments shall be in Bitcoin. You
        ...
        <section>
          ...
          an undue burden on the Services or the networks or services connected
          to the Services. Harass, annoy, intimidate, or threaten any of our
        ...
        <section>
          ...
          WOULD HA VE THE RIGHT TO SUE IN COURT AND HA VE A JURY TRIAL. The
          ...
          at the American Arbitration Association (AAA) website. Your
          ...
          place in United States, New Jersey. Except as otherwise provided
          ...
          these Legal Terms. In no event shall any Dispute brought by either
        ...
        <section>
          ...
          TRANSMITTED, OR OTHERWISE MADE A V AILABLE VIA THE SERVICES. WE DO NOT
        ...
        <section>
          ...
          USE OF THE SERVICES, EVEN IF WE HA VE BEEN ADVISED OF THE POSSIBILITY
          ...
          MAY NOT APPLY TO YOU, AND YOU MAY HA VE ADDITIONAL RIGHTS.
        </section>
        ...
        <section>
          ...
          all of our rights and obligations to others at any time.<br />
