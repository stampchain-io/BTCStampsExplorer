...
import { UploadTickHeader } from "$islands/upload/UploadTickHeader.tsx";
import { UploadImageHeader } from "$islands/upload/UploadImageHeader.tsx";
...
export const UploadTickPage = (props) => {
  const {
    deployment,
    sends,
    mints,
