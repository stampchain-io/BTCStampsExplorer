              ...
              <div
                className={`${
                  isMobile
                    ...
                    : "hidden group-hover:flex flex-col absolute top-[100%] left-0 z-10 pt-[3px] pb-[15px] space-y-[3px] w-full backdrop-blur-md bg-gradient-to-b from-transparent to-[#171717]/30 rounded-b-lg"
                }`}
              >
