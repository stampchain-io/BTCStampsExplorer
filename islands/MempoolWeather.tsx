...
export const MempoolWeather = () => {
  ...
  return (
    <div style={{ marginTop: '-22px' }} class="flex flex-col p-1 w-full text-[11px] mb-4 text-white rounded-lg">
      ...
      <div class="flex items-center">
        {loading ? (
          ...
          <>
            <div class="text-3xl sm:text-4xl py-1 px-4">{!loading && determineWeatherIcon(fees._hourFee)}</div>
            <div class="flex-grow">
              <table class="min-w-full divide-y divide-gray-200">
                <tbody>
                  <tr>
                    <th class="px-1 py-.5 text-left font-medium text-gray-500 uppercase tracking-wider">SPEED</th>
                    ...
                    <td class="px-1 py-.5 whitespace-nowrap">
                      <div class="flex items-center uppercase">Block</div>
                    </td>
                  </tr>
                  <tr>
                    <th class="px-1 py-.5 text-left font-medium text-gray-500 uppercase tracking-wider">FEE (sat/vB)</th>
                    <td class="px-1 py-.5 whitespace-nowrap">{fees.economyFee}</td>
                    <td class="px-1 py-.5 whitespace-nowrap">{fees.fastestFee}</td>
                    <td class="px-1 py-.5 whitespace-nowrap">{fees.recomendedFee}</td>
                    <td class="px-1 py-.5 whitespace-nowrap">{fees.block}</td>
                  </tr>
                </tbody>
              </table>
            </div>
