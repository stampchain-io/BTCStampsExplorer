  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-[#999999] text-sm md:text-lg font-medium">
        ...
        mint. <br />
        Double-check that the displayed information matches the ticker you wish
        to mint.<br />
        <br />
        ...
        <b>Fee</b>{" "}
        displays the suggested amount, which can be adjusted using the slider.
        {" "}
        <br />
        ...
        Accept the <b>terms and conditions</b> to enable the mint button.<br />
        <br />
