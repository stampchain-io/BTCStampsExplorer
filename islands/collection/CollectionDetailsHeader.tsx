    ...
    <div className="flex flex-col gap-3">
      <div className="dark-gradient p-6">
        <div className="flex gap-4">
          ...
          />
          <div>
            <p className="font-black text-6xl purple-gradient3">{id}</p>
      ...
      <div className="flex justify-between dark-gradient p-6">
        <div className="text-left">
          ...
          <p className="text-[#999999] text-4xl font-black">XX</p>
        </div>
        <div className="text-center">
          <p className="text-[#666666] text-xl font-light">EDITIONS</p>
          <p className="text-[#999999] text-4xl font-black">XXXX</p>
        </div>
        <div className="text-right">
          <p className="text-[#666666] text-xl font-light">FLOOR PRICE</p>
          <p className="text-[#999999] text-4xl font-black">
            X.XXXX <span className="font-extralight">BTC</span>
          </p>
        </div>
      </div>
      ...
      <div className="flex justify-between dark-gradient p-6">
        ...
        <div className="text-right">
          ...
          <p className="text-[#999999] text-4xl font-black">XXX</p>
        </div>
      </div>
    </div>
  );
