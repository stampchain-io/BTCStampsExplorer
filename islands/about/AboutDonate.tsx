...
import { DonateStyles } from "$islands/about/styles.ts";
    ...
    <>
      <section>
        <div className="w-full flex flex-col justify-center items-start">
          <h1 className={DonateStyles.titlePurpleDL}>
            DONATE
          </h1>
          <h3 className={DonateStyles.subTitlePurple}>
            TO THE DEV FUND
          </h3>
        </div>
        <p className={`${DonateStyles.bodyTextLight} tablet:hidden block`}>
        ...
        <div className="grid grid-cols-12">
          <div className="mobileMd:col-span-8 col-span-12">
            <p className={`${DonateStyles.bodyTextLight} tablet:block hidden`}>
            ...
            <div className="grid grid-cols-12 mt-6 mb-6">
              <div className="col-span-6 flex flex-col justify-center items-center">
                <p className={DonateStyles.dataLabel}>
                  MONTHLY EXPENSES
                </p>
                <p className={DonateStyles.dataValueXl}>
            ...
            <div className="hidden mobileMd:flex justify-start gap-[18px] tablet:gap-6">
              ...
              >
                ...
                <div
                  class={`${DonateStyles.tooltipIcon} ${
          ...
          <div className="mobileMd:col-span-4 col-span-12 flex flex-col gap-5 justify-center items-center">
            ...
            <button
              onClick={handleOpen}
              className={DonateStyles.buttonPurpleOutline}
            >
              DONATE
            </button>
          </div>
