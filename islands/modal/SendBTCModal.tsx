    ...
    >
      ...
      <div class="flex flex-col gap-6 -mt-3">
        <div class="flex flex-col items-center text-center">
          <div class="flex justify-center items-baseline w-full">
            ...
            >
              <input
                ...
                placeholder="0"
                class="bg-transparent text-[30px] mobileLg:text-[42px] text-color-neutral-light placeholder:text-color-neutral font-black text-right -ms-0 mobileLg:-ms-0 pointer-events-auto no-outline"
                style={{
                  width: (() => {
              ...
              />
              <span class="text-[30px] mobileLg:text-[42px] text-color-neutral-light font-extralight">
                BTC
              </span>
            </div>
          </div>
          ...
          {/* ===== USD CONVERSION ===== */}
          <div class="text-sm mobileLg:text-base text-color-neutral-semidark font-light">
          ...
          {/* ===== MAX BUTTON ===== */}
          <div
            className="relative text-base mobileLg:text-lg text-color-neutral font-medium hover:text-color-neutral-light mt-2 cursor-pointer"
