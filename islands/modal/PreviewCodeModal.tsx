...
export default function PreviewCodeModal({ src }: PreviewCodeModalProps) {
  ...
  return (
    <ModalBase
      ...
      contentClassName="h-full bg-[#FAFAFA] rounded-xl mobileMd:rounded-2xl overflow-auto scrollbar-grey"
    >
      {/* ===== CODE DISPLAY ===== */}
      <div class="flex flex-col w-full h-full p-6 mobileMd:p-9">
        <code class="whitespace-pre-wrap text-xs text-color-neutral-dark leading-tight pb-6 mobileMd:pb-9">
          {formattedSrc}
        </code>
      </div>
    </ModalBase>
