  ...
  return (
    <>
      <input
        ...
        autoFocus={autoFocus}
        class={`relative z-modal h-12 w-full bg-[#080708]/50 pl-7.5 pr-[68px] font-medium text-sm text-color-neutral-light placeholder:bg-[#080708]/50 placeholder:font-light placeholder:!text-color-neutral no-outline ${
