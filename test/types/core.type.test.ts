...
import type {
  ...
  StampStatus,
  StampMetadata,
  StampProtocolCompliance,
  StampValidationResult,
  StampValidationError,
  ValidatedStamp,
  StampTransactionRelationship,
  StampTransactionType,
  StampUTXOReference,
  StampTransactionParsingContext,
  StampParsingResult,
...
import type {
  ...
  Src20TransferData,
  SRC20TokenMetadata,
  SRC20ValidationResult,
  SRC20HolderAnalytics,
  SRC20MarketMetrics,
  SRC20TrendingAnalysis,
  SRC20ProgressTracker,
  Src20BalanceQueryResponse,
...
Deno.test("Core Types - Dependency Analysis", async () => {
  ...
  const analysis = await analyzeDependencies("/Users/kevinsitzes/Documents/BTCStampsExplorer", typeFiles);
