  ...
  private static enrichStampWithMarketData(
    ...
    return {
      ...
      market_data: marketData ? {
        ...
        total_volume_btc: marketData.totalVolumeBTC || 0,
        total_volume_usd: marketData.totalVolumeBTC ? marketData.totalVolumeBTC * btcPriceUSD : null,
      ...
      marketData: marketData ? {
        ...
        totalVolumeBTC: marketData.totalVolumeBTC || 0,
