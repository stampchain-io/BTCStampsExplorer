...
import type { CollectionValidationErrorCode } from "$constants";
...
export interface CollectionRow {
  ...
  stamps: number[];
  img: string;
  marketData?: CollectionMarketData | null; // Add optional marketData
}
...
// Re-export CollectionValidationErrorCode from $constants
export { CollectionValidationErrorCode } from "$constants";
 ...
 */
export function isCollectionWithMarketData(value: any): value is CollectionWithOptionalMarketData;
