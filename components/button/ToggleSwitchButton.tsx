  ...
  useEffect(() => {
    ...
    if (handleElement) {
      ...
      innerDiv.className = `${toggleKnob} ${
        isActive ? "bg-color-neutral-light/70" : "bg-color-neutral/70"
    ...
    if (handleElement) {
      if (isActive) {
        ...
        setTimeout(() => {
          ...
          const innerDiv = document.createElement("div");
          innerDiv.className =
            `${toggleKnob} bg-color-neutral-light/70 flex items-center justify-center ${toggleSymbol} mr-1`;
        ...
        setTimeout(() => {
          ...
          const innerDiv = document.createElement("div");
          innerDiv.className =
            `${toggleKnob} bg-color-neutral/70 flex items-center justify-center ${toggleSymbol}`;
