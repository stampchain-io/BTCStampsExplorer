...
export function MaraModeIndicator({
  ...
  return (
    <div
      ref={containerRef}
      class={`flex items-center gap-2 bg-purple-900/20 backdrop-blur-sm border border-purple-500/30 rounded-lg px-3 py-2 cursor-help focus:outline-none focus:ring-2 focus:ring-purple-400 ${className}`}
      role="button"
      tabIndex={0}
    ...
    >
      ...
      {showTooltip && (
        <div
          class="fixed z-50 bg-stamp-grey-darkest/95 backdrop-blur-sm border border-stamp-grey-light/20 rounded-lg px-4 py-3 shadow-lg max-w-xs text-sm pointer-events-none"
          style={{
