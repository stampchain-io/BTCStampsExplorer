...
export function MaraStatusLink(
  ...
  return (
    ...
    >
      <div class="flex items-center justify-between gap-4">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xs text-color-neutral-light mt-1">
      ...
      <div class="mt-3 text-xs text-color-neutral break-all">
        <span class="text-color-neutral-light">Transaction ID:</span> {txid}
      </div>
    </div>
  );
}
