...
export function CollectionOverviewCard(
  ...
  return (
    <a
      ...
      className={`rounded-md w-full dark-gradient p-3 mobileLg:p-6 flex flex-col gap-6 hover:border-stamp-purple-bright hover:shadow-stamp hover:border-solid border-2 border-transparent`}
    >
