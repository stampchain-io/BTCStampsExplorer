...
export const shadowGlowPurple =
  `group hover:shadow-[0px_0px_16px_color-mix(in_srgb,var(--color-primary-light)_75%,transparent)] ${transitionColors} cursor-pointer`;
export const shadowGlowGrey =
  `group hover:shadow-[0px_0px_16px_color-mix(in_srgb,var(--color-neutral-light)_75%,transparent)] ${transitionColors} cursor-pointer`;
