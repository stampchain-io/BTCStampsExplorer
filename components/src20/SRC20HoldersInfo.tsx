      ...
      <Chart
        ...
        data={{
          datasets: [{
            ...
            borderColor: "#000000",
            backgroundColor: [
              transparentize(ChartColors.Red, 0.5),
              transparentize(ChartColors.Orange, 0.5),
              transparentize(ChartColors.Yellow, 0.5),
              transparentize(ChartColors.Green, 0.5),
              transparentize(ChartColors.Blue, 0.5),
            ],
            borderWidth: 1,
          }],
        }}
