  ...
  return (
    ...
    >
      ...
      <div className="flex w-full gap-6">
        <div className="min-w-[106px] min-h-[106px] max-w-[106px] max-h-[106px] mobileLg:min-w-[96px] mobileLg:min-h-[96px] mobileLg:max-w-[96px] mobileLg:max-h-[96px] rounded aspect-stamp image-rendering-pixelated overflow-hidden">
        ...
        <div className="w-full">
          <div className="flex flex-col justify-between w-full">
            {/* check code */}
            <h2 className="font-black text-2xl gray-gradient1 group-hover:[-webkit-text-fill-color:#AA00FF] inline-block w-fit">
